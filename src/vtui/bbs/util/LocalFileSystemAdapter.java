...
public class LocalFileSystemAdapter implements FileSystemAdapter {
	...
	static{
        FileSystem.registerAdapter("file", LocalFileSystemAdapter.class);
	}
	
		
	public LocalFileSystemAdapter(URL url){
		fsRoot = new File(url.getPath());
	...
	public FileAdapter getFile(String file){
		return new IOFileAdapter(realFile(reducePath(file)));
	}
	...
	private void addFile(String dir,Map<String,FileAdapter> tree){
		...
		}else{ tree.put(dir,new IOFileAdapter(rf)); }
